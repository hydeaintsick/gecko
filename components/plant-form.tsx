...
const PLANT_DATABASE = [
  ...
  { value: "sansevieria-trifasciata", label: "Sansevieria Trifasciata (Snake Plant)" },
  { value: "zamioculcas-zamiifolia", label: "Zamioculcas Zamiifolia (ZZ Plant)" },
  { value: "pothos-aureum", label: "Epipremnum Aureum (Pothos)" },
  { value: "calathea-orbifolia", label: "Calathea Orbifolia" },
  { value: "spathiphyllum-wallisii", label: "Spathiphyllum Wallisii (Peace Lily)" },
  { value: "chlorophytum-comosum", label: "Chlorophytum Comosum (Spider Plant)" },
]

export default function PlantForm({ initialData = null, onSubmit }) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-4">
        <div>
          ...
          <Select
            value={PLANT_DATABASE.find((p) => p.label === formData.latinName)?.value || ""}
