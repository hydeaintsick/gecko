      ...
      >
        ...
        >
          ...
          <p className="text-xl mb-6 text-muted-foreground">
            Your adorable plant companion that helps you nurture your green
            friends 🌿
          </p>
        ...
        <div className="max-w-md mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground">
              Your plants deserve the best care, and Gecko is here to help!
            </p>
          </motion.div>
          ...
          <div className="grid gap-10">
            ...
            >
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Never forget to water your plants again. Gecko reminds you
                  when each plant needs attention.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Track sunlight needs for each plant and get reminders to
            ...
            >
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Keep a beautiful record of your plant's growth journey with
                  photos and notes.
                </p>
              </div>
            </motion.div>
        ...
        <div className="max-w-md mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              A beautiful, intuitive interface designed with plant lovers in
              mind
            </p>
